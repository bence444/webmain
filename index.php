...
<html>
	...
	<body class="bg-dark text-light">
		<div class="bg">
			<div class="shadow">
				<div class="d-flex justify-content-center align-items-end h-50 text-light pb-0 my"><h1 class="display-2 fade-in">Bence Lovász</h1></div>
				<div class="d-flex justify-content-center align-items-start h-50 text-light pt-0"><h4 class="h4 text-info slide-fade-in" style="font-weight: bolder; letter-spacing: 29px; margin-right: -29px;">lorem ipsum</h4></div>
			</div>
		</div>
		...
		<!-- <div class="w-75 mt-5 bg-info mx-auto border border-info rounded-5 ps-2 pe-3">
			<div class="d-flex flex-row justify-content-start align-items-center" style="height: 50px;">
				...
				<a class="text-light cursor" href="https://twitter.com/yngnbs"><i class="fab fa-lg fa-twitter-square me-2"></i></a>
				<a class="text-light cursor" href="https://github.com/bence444"><i class="fab fa-lg fa-github-square"></i></a>
			</div>
		</div> -->

		<div class="w-75 row p-0 mx-auto mt-5 pt-5">
		...
		<div class="w-75 row mx-auto p-5 mt-5 bg-dark-d rounded z-depth-2">
